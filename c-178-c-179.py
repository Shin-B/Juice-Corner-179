...
label_heading = Label(root, text=" Shin-B's Juice Corner",bg="orange2", font=("sylfaen",18,"bold","italic"))
...
btn = Button(root, text="TOTAL", bg="red3", fg="white", padx=10, pady=1,font=("Arial",11,"bold"), relief=GROOVE,  command=orderJuice)
